...
\barcode{% templatetag openbrace %}{{ student_registration.id }}{% templatetag closebrace %}
}
...
{% comment %}TODO: \texttt{% templatetag openbrace %}{{ cls.emailcode }}{% templatetag closebrace %} \\{% endcomment %}
{% endfor %}\hline
\end{tabularx}
\end{center}
\begin{center}
