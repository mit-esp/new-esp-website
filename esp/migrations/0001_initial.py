    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_on', models.DateTimeField(auto_now=True)),
                ('is_deleted', models.BooleanField(default=False)),
                ('day', models.CharField(blank=True, choices=[('monday', 'Mon'), ('tuesday', 'Tues'), ('wednesday', 'Wed'), ('thursday', 'Thurs'), ('friday', 'Friday'), ('saturday', 'Sat'), ('sunday', 'Sun')], max_length=16, null=True)),
