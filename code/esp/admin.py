...
admin.site.register(program_registration_models.StudentRegistration)
admin.site.register(program_registration_models.TeacherRegistration)
...
admin.site.register(program_registration_models.CompletedStudentRegistrationStep)
